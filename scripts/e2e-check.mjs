...
try {
  ...
  const cases = [
    ...
    // ── Danh bạ + nhóm ──
    ['GET contacts không có phiên', 'GET', '/sessions/x/contacts', null, 404],
    ['POST contacts thiếu phone lẫn username', 'POST', '/sessions/x/contacts', {}, 400],
    ['POST contacts không có phiên', 'POST', '/sessions/x/contacts', { username: 'ai_do' }, 404],
    ['POST resolve thiếu mọi tham số', 'POST', '/sessions/x/resolve', {}, 400],
    ['POST resolve không có phiên', 'POST', '/sessions/x/resolve', { username: 'ai_do' }, 404],
    ['GET group members không có phiên', 'GET', '/sessions/x/groups/1/members', null, 404],
    ['POST group members thiếu userId', 'POST', '/sessions/x/groups/1/members', {}, 400],
    ['DELETE group member không có phiên', 'DELETE', '/sessions/x/groups/1/members/2', null, 404],
    ['POST group rename thiếu title', 'POST', '/sessions/x/groups/1/rename', {}, 400],
    ['POST group rename không có phiên', 'POST', '/sessions/x/groups/1/rename', { title: 'A' }, 404],
